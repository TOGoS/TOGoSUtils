...
;; This library, which I downloaded from https://www.emacswiki.org/emacs/download/uuid.el,
;; uses math-fixnum, which used to be provided by calc-ext.el, but no longer is.
;; Here are the old definitions, copied from
;; https://fossies.org/diffs/emacs/26.3_vs_27.1/lisp/calc/calc-ext.el-diff.html
;; -- TOGoS, 2023-08-20
(defun math-fixnum (a)
  (if (consp a)
      (if (cdr a)
