...
if not defined CCOUCH3_TOGNET_REMOTE_ARGS set "CCOUCH3_TOGNET_REMOTE_ARGS=-remote-repo external.marvin.nuke24.net:31580 -remote-repo fs.marvin.nuke24.net"
