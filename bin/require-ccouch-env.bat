...
if not defined fs_marvin_ssh_hostname set fs_marvin_ssh_hostname=fs.marvin.nuke24.net
if not defined fs_marvin_ssh_port set fs_marvin_ssh_port=22
if not defined togos_fbs_ssh_hostname set togos_fbs_ssh_hostname=togos-fbs.nuke24.net
