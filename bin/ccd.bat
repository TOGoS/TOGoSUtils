...
set "ccd_guess=%UserProfile%\stuff\data\%ccd_target%"
%ccd_debug% Trying %ccd_guess%
if exist "%ccd_guess%" goto guess_okay
...
if "%ccd_target%" == "ai" (set "ccd_target=docs\ArchiveInfo" & goto guess)
...
if "%ccd_target%" == "fm" (set "ccd_target=data\FileManifests" & goto guess)
